...
if(isset($_POST['datos'])){
    ...
    switch($operacion){
        ...
        case "crearCatServicio":
             ...
             */
            //var_dump($post->datos);
            $objeto->nombre_categoria_servicio=trim($post->datos->nombre_categoria);
            $objeto->descripcion_categoria_servicio=trim($post->datos->descripcion_categoria);
            $objeto->imagen_categoria_servicio=trim($post->datos->imagen_categoria);
            $r=$objeto->crear_registro_categoria_servicio();
            if($r["respuesta"]){
        ...
        case "actualizarCatServicio":
            ...
            $r=$objeto->actualizar_recurso_cat_servicio();
            if($r["respuesta"]){
        ...
        case "eliminarCatServicio":
             ...
             */
            $objeto->id_categoria=trim($post->datos->id_categoria);
            echo json_encode($objeto->eliminar_recurso_cat_servicio());
            break;
        case "consultar":
            echo json_encode($objeto->obtener_registro_todos_los_registros());
            break;
        
        case "consultarCatServicio":
            echo json_encode($objeto->obtener_registro_todos_los_registros_cat_servicio());
            break;
        case "consultarPorValor":
            echo json_encode($objeto->obtener_registro_por_valor($post->datos->valor));
            break;
        case "consultarCatServicioPorValor":
            echo json_encode($objeto->obtener_registro_por_valor_cat_servicio($post->datos->valor));
            break;
        default :

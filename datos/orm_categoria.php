...
class Categoria extends ModeloBaseDeDatos{
    ...
    function crear_registro_categoria_servicio(){
        
        $this->sentencia_sql="SELECT fun_crear_categoria_servicio('$this->nombre_categoria_servicio','$this->descripcion_categoria_servicio') as respuesta";
    ...
    function obtener_registro_todos_los_registros_cat_servicio(){
        
        $this->sentencia_sql="CALL pa_consultar_todas_las_categorias_servicios()";
    ...
    function obtener_registro_por_valor_cat_servicio($valor){
         $this->sentencia_sql="CALL pa_consultar_categoria_por_identificacion_servicio('$valor%')";
    ...
    function eliminar_recurso_cat_servicio(){
        $this->sentencia_sql="SELECT fun_eliminar_categoria_servicio('$this->id_categoria') as respuesta";
        if($this->eliminar_registro()){
            return array("mensaje"=> $this->mensajeDepuracion,
                "respuesta"=>TRUE);
        }else{
    ...
    function actualizar_recurso_cat_servicio(){
        
        $this->sentencia_sql="SELECT fun_actualizar_categoria_servicio('$this->id_categoria','$this->nombre_categoria','$this->descripcion_categoria') as respuesta";
        if($this->actualizar_registro()){
            return array("mensaje"=> $this->mensajeDepuracion,
                "respuesta"=>TRUE);
        }else{
